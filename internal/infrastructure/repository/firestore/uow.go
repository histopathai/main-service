...
func (f *FirestoreUnitOfWorkFactory) WithTx(
	ctx context.Context,
	fn func(ctx context.Context, repos *port.Repositories) error,
) error {
...
func (f *FirestoreUnitOfWorkFactory) WithoutTx(ctx context.Context) (*port.Repositories, error) {
	return f.repos, nil
}
